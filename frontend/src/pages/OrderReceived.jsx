...
const orderReceived = () => {
    ...
    <div id="print-content">
        ...
        <h1 style={{fontSize:"100px" , fontWeight:"bolder"}}  >MED<span style={{color: "#FFB800"}}>HIVE</span></h1>
            ...
            Your order has been successfully recieved us. Your Oder contains Non OTC medicines, Therefore, our phamacists will review your prescription and after acception of the prescription we will notify you through Email.
            <br/>
                Then you can proceed to the payment options.<br/>
